...
public class AddWorkoutActivity extends AppCompatActivity {
    ...
    private MaterialButton btnSaveWorkout, btnCancel, btnBack, btnThemeToggle;
    ...
    private void showDatePicker() {
        ...
        // Prevent future dates (optional improvement)
    ...
    private void saveWorkout() {
        ...
        if (databaseHelper.addWorkout(userId, workoutType, durationValue, caloriesValue, notes.isEmpty() ? "" : notes, workoutDateTime)) {
